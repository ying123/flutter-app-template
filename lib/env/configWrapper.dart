...
class ConfigWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AppConfig.DEBUG = this.config.debug;
    print("ConfigWrapper build ${AppConfig.DEBUG}");
...
class _InheritedConfig extends InheritedWidget {
  const _InheritedConfig({Key key, @required this.config, @required Widget child}): assert(child != null),
